...
Now run it against this repo::
    ...
    $ cookiecutter ./django-opera --no-input # this will create a `dopera` proejct.
...
Create a git repo and push it there::
    ...
    $ git remote add origin git@github.com:yourname/dopera.git
...
Create DB::
    ...
    # in psql:
    $ CREATE USER dopera WITH PASSWORD 'mysecretpass';
    $ CREATE DATABASE dopera OWNER dopera;
    $ \q
    $ exit # return back to previous user
